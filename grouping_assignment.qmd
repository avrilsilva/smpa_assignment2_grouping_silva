...
# To differentiate between how much was spent between 2017 and 2018, I made sure to group the values by the reported year and then make a new field for the total spent in each year by using the sum function to add up all the disbursements. 
